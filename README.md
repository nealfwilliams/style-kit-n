...
`style-kit-n` is built with React and Typescipt DX as its first priority. The intention of `style-kit-n` is 
to build a framework that feels as natural and accessibility to developers as any other part of 
the React ecosystem.
